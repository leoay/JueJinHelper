...
func Fetch(method string, urlStr string, post interface{}, header map[string]string) (int, []byte, error) {
...
// header (header 请求头数据), 进行网站访问。
// 返回值分别为 []byte, 错误信息
func (h *HTTPClient) Fetch(method string, urlStr string, post interface{}, header map[string]string) (int, []byte, error) {
